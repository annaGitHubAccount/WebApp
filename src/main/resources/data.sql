...
insert into Produkt_Stammdaten(id, name, preis, isAktiv) values ( 1, 'Produkt1', 100, true);
insert into Produkt_Stammdaten(id, name, preis, isAktiv) values (2, 'Produkt2', 250, true);
insert into Produkt_Stammdaten(id, name, preis, isAktiv) values (3, 'Produkt3', 500, false);
insert into Produkt_Stammdaten(id, name, preis, isAktiv) values (4, 'Produkt4', 1000, true);